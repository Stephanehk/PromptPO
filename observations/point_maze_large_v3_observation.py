"""
Structured observation for Gymnasium-Robotics PointMaze_Large-v3.
...
- desired_goal: (2,) target position
...
class PointMazeLargeV3Observation:
    """
    PointMaze large v3 observation bundle for policies and reward code.
